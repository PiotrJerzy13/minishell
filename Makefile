...
# OBJDIR = ./bin
# SRCS = main.c enviroment.c memories.c commands.c token.c token_helper.c copy_enviroment.c builtin.c signals.c command_helper.c
...
CC = cc
CFLAGS = -Wall -Wextra -Werror
LDFLAGS = -L/opt/homebrew/opt/readline/lib -lreadline  # Link with readline library
CPPFLAGS = -I/opt/homebrew/opt/readline/include        # Include readline headers
OBJDIR = ./bin
SRCS = main.c enviroment.c memories.c commands.c token.c token_helper.c copy_enviroment.c builtin.c signals.c command_helper.c
OBJS = $(SRCS:%.c=$(OBJDIR)/%.o)
