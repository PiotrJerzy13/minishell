...
OBJDIR = ./bin
SRCS = main.c enviroment.c memories.c commands.c token.c token_helper.c copy_enviroment.c signals.c bui_cd.c bui_echo.c bui_exit.c bui_pwd.c bui_export.c
